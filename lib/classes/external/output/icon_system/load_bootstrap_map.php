...
/**
 * A web service to load the mapping of moodle pix names to bootstrap icon names.
 *
 * @package    core
 * @category   external
...
use external_value;
use core\output\icon_system_bootstrap;
use theme_config;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class load_bootstrap_map extends external_api {
