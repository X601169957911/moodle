...
const registerEventListeners = () => {
    ...
    $(selectors.userMenu).on('shown.bs.dropdown', function() {
    ...
    userMenu.addEventListener('click', (e) => {
        ...
        if (e.target.matches(selectors.userMenuCarouselNavigationLink)) {
            ...
            const targetedCarouselItemId = e.target.getAttribute('data-carousel-target-id');
    ...
    $(selectors.userMenuCarousel).on('slid.bs.carousel', function() {
