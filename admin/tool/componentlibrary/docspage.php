...
$jsonfile = $CFG->wwwroot . '/admin/tool/componentlibrary/hugo/site/data/my-index.json';
$PAGE->requires->js_call_amd('tool_componentlibrary/search', 'init', ['jsonfile' => $jsonfile]);
